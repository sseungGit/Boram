...
<div id="subnav">
    <c:choose>
    	<c:when test="${param.thisPage eq 'guide'}">
	 	...
	 	<c:when test="${param.thisPage eq 'cs'}">
	    	<div id="image-box">
	    		<img id="image-thumbnail" 
...
<nav class="bg-light">
  <div id="subNavbar">
    ...
    <c:choose>
    	...
    	<c:when test="${param.thisPage eq 'cs'}">
			<ul id="subNavUl">
				<li class="subNav-item" ${param.subPage eq 'review' ? 'deco' : ''}>
				  	<a class=" ${param.subPage eq 'review' ? 'active' : ''}" aria-current="page" href="#">후기게시판</a>
				</li>
				<li class="subNav-item" ${param.subPage eq 'faq' ? 'deco' : ''}>
				  	<a class=" ${param.subPage eq 'faq' ? 'active' : ''}" href="#">질문게시판</a>
				</li>
				<li class="subNav-item"- ${param.subPage eq 'notice' ? 'deco' : ''}>
