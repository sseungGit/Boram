...
<div class="container">
    ...
    <main id="order_wrap">
        <div class="left">
            <img src="${pageContext.request.contextPath}/reserve_img/운동화빨래방법.jpg">
        </div>
        <div class="right">
            <div class="top">
                <h1>상품 구매</h1>
    ...
    function nextViewPage(){
    	...
    	var text = '${pageContext.request.contextPath}/reserve/reserve_credit.do?name='+sum+'&price='+sum2+'&count='+sum3;
    	location.href=text;
    }
    </script>
